...
class Beam:
    ...
    def __init__(self, bird:"Bird"):
        ...
        self.rct.centery  = bird.rct.centery    #中心座標
...
class Score:
    def __init__(self, num: str, color: tuple[int, int, int]):
        self.fonto = pg.font.SysFont("hgp創英角ﾎﾟｯﾌﾟ体", 30)
        self.img = self.fonto.render("Score"+num, True, color)
...
def main():
    ...
    while True:
        ...
        for bomb in bombs:
            bomb.update(screen)
        score = Score(str(NUM_OF_BOMBS-len(bombs)),(0, 0, 255))
        score.update(screen)
